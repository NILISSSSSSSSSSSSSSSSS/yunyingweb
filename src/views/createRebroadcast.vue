  ...
  <div>
    ...
    <el-card class="box-card course-header">
      <div class="course-header-main">
        <div class="course-header-back">
          <el-button size="mini" icon="el-icon-back" circle @click="$router.back(-1)"></el-button><span> 回播/新增</span>
        </div>
      </div>
    </el-card>
    <el-card class="box-card course-main">
        ...
        <el-tab-pane label="话术" name="话术">
          ...
          <el-table :data="verbaltrick == '课前话术' ? rebroadcast.prefixItems : rebroadcast.suffixItems" style="width: 100%" height="500" row-key="content" id="prefixItems" @selection-change="selectionChange">
            ...
            <el-table-column prop="length" label="延时/s" width="120">
              <template slot-scope="scope" >
                <!-- <el-input v-model.trim='scope.row.realTime' v-if="scope.$index == 1" clearable/> -->
      ...
      <div class="bottom clearfix">
        <el-button @click="createRebroad" type='primary' icon='el-icon-check' size="mini" v-if="tabName == '客服小助手'">保存</el-button>
    ...
    <el-dialog title="选择课件" :visible.sync="kejianDialog" width="70%">
      <div class="mendian" style="display: flex;">
        <div class="mendian-search">
            ...
            <el-table :data='courseList.data' class="box left-table" stripe @row-click="selectCourse" height="300">
    ...
    <el-dialog :visible.sync='dialogImageData.isShow' :title="'上传图片/音频/视频'" width='600px' :close-on-click-modal='false'>
      <el-form labelWidth='120px'>
        ...
        <el-form-item label='上传文件'>
          ...
          <!-- <video v-if="dialogImageData.content" :src="dialogImageData.content" class="mt10" style="width:300px" controls></video> -->
        </el-form-item>
      </el-form>
    ...
    methods: {
      ...
      handlePrefixItemsImgSuccess(res, file) {
        ...
        if(res.code === 200){
          ...
          // this.dialogImageData.content = res.data.url;
          // this.dialogImageData.contentName = res.data.filename;
          // this.dialogImageData.fileLength = res.data.voiceLength;
          // console.log(this.dialogImageData.fileLength)
      ...
      createRebroad () {
        ...
        console.log(this.rebroadcast.prefixItems)
        console.log(this.rebroadcast.prefixItems[0])
        ...
        console.log(this.rebroadcast)
        api.createHuibo(this.rebroadcast).then(res => {
          if(res.code === 200){
